...
import com.example.cryptinfo.mvp.contract.LatestChartContract
...
class ChartActivity : AppCompatActivity(), OnChartValueSelectedListener, LatestChartContract.View {
    ...
    @Inject lateinit var latestChart: LatestChart

    @Inject lateinit var presenter: LatestChartPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val priceChangePercentage24h = intent?.getFloatExtra("priceChangePrcentage24h",0.0f)
