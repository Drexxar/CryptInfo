...
class CurrenciesAdapter : BaseAdapter<CurrenciesAdapter.CurrencyViewHolder>() {
    ...
    //создает VH и инициализирует view для списка
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CurrenciesAdapter.CurrencyViewHolder {
    ...
    class CurrencyViewHolder(view: View) : BaseAdapter.BaseViewHolder(view){
        //переменные для данных в экране доп информации
        var id: String = ""
        var symbol: String = ""
        var name: String = ""
        var image: String = ""
        ...
        override fun bind(item: Any){
            let{
                ...
                view.tvCurrencySum.text = item.symbol
